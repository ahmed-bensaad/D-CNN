...
def wsp_model(features, labels, mode):
    ...
    #fc4
	fc4 = tf.layers.dense(inputs=conv3, units=512, activation=tf.nn.relu)
	...
	#fc5
	fc5 = tf.layers.dense(inputs=dropout, units=19) #a unit for each class
...
def main(unused_argv):
  ...
  model_fn=wsp_model, model_dir="/tmp/mnist_convnet_model")
